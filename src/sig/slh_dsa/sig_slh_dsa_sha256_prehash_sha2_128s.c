...
OQS_SIG *OQS_SIG_slh_dsa_sha256_prehash_sha2_128s_new(void) {
	...
	sig->method_name = OQS_SIG_alg_slh_dsa_sha256_prehash_sha2_128s;
	...
	sig->length_public_key = OQS_SIG_slh_dsa_sha256_prehash_sha2_128s_length_public_key;
	sig->length_secret_key = OQS_SIG_slh_dsa_sha256_prehash_sha2_128s_length_secret_key;
	sig->length_signature = OQS_SIG_slh_dsa_sha256_prehash_sha2_128s_length_signature;

	sig->keypair = OQS_SIG_slh_dsa_sha256_prehash_sha2_128s_keypair;
	sig->sign = OQS_SIG_slh_dsa_sha256_prehash_sha2_128s_sign;
	sig->verify = OQS_SIG_slh_dsa_sha256_prehash_sha2_128s_verify;
	sig->sign_with_ctx_str = OQS_SIG_slh_dsa_sha256_prehash_sha2_128s_sign_with_ctx_str;
	sig->verify_with_ctx_str = OQS_SIG_slh_dsa_sha256_prehash_sha2_128s_verify_with_ctx_str;
