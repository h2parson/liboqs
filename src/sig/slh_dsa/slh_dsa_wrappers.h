...
int slh_sign_with_ctx_wrapper(uint8_t *sig, size_t *siglen __attribute__((unused)), const uint8_t *m,
...
int hash_slh_sign_with_ctx_wrapper(uint8_t *sig, size_t *siglen __attribute__((unused)),
...
int hash_slh_sign_wrapper(uint8_t *sig, size_t *siglen __attribute__((unused)), const uint8_t *m,
    size_t mlen, const uint8_t *sk, const slh_param_t *prm);
