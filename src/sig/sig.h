...
#define OQS_SIG_SLH_DSA_algs_length 156///// OQS_COPY_FROM_SLH_DSA_FRAGMENT_ALGS_LENGTH_END
...
#endif /* OQS_ENABLE_SIG_SLH_DSA *////// OQS_COPY_FROM_SLH_DSA_FRAGMENT_INCLUDE_END
