...
struct OQS_SHA2_callbacks {
	...
	*/
	 ...
	 */
	 ...
	 /**
	  * Implementation of function OQS_SHA2_sha512_224_inc_init.
	  */
	 void (*SHA2_sha512_224_inc_init)(OQS_SHA2_sha512_ctx *state);
	 ...
	 */
	 ...
	 /**
	  * Implementation of function OQS_SHA2_sha512_256_inc_init.
	  */
	 void (*SHA2_sha512_256_inc_init)(OQS_SHA2_sha512_ctx *state);
};
