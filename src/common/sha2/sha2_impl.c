...
static void SHA2_sha512_224_inc_init(OQS_SHA2_sha512_ctx *state) {
	oqs_sha2_sha512_224_inc_init_c((sha512ctx *)state);
}

static void SHA2_sha512_256_inc_init(OQS_SHA2_sha512_ctx *state) {
	oqs_sha2_sha512_256_inc_init_c((sha512ctx *)state);
}

static void SHA2_sha224(uint8_t *out, const uint8_t *in, size_t inlen) {
	C_OR_ARM (
