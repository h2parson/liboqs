...
static const uint8_t iv_512_224[64] = {
...
static const uint8_t iv_512_256[64] = {
...
void oqs_sha2_sha512_224_c(uint8_t *out, const uint8_t *in, size_t inlen) {
	...
	oqs_sha2_sha512_224_inc_init_c(&state);
	oqs_sha2_sha512_inc_finalize_c(out, &state, in, inlen);
}
...
void oqs_sha2_sha512_256_c(uint8_t *out, const uint8_t *in, size_t inlen) {
	...
	oqs_sha2_sha512_256_inc_init_c(&state);
	oqs_sha2_sha512_inc_finalize_c(out, &state, in, inlen);
}
