 ...
 */
 void OQS_SHA2_sha224(uint8_t *output, const uint8_t *input, size_t inplen);

 /**
  * \brief Allocate and initialize the state for the SHA-256 incremental hashing API.
  *
  * \warning The state must be released by OQS_SHA2_sha224_inc_finalize
  * or OQS_SHA2_sha224_inc_ctx_release.
  *
  ...
  * for releasing dest by calling either OQS_SHA2_sha224_inc_finalize or
  ...
  *
  * \warning The state must be initialized by OQS_SHA2_sha224_inc_init or OQS_SHA2_sha224_inc_ctx_clone.
  *
  ...
  *
  * \warning The output array must be at least 28 bytes in length. The state is
  * deallocated by this function and can not be used again after calling
  * this function without calling OQS_SHA2_sha224_inc_init again.
  *
 ...
 */
 ...
 /**
  * \brief Allocate and initialize the state for the SHA-512-224 incremental hashing API.
  *
  * \warning The state must be released by OQS_SHA2_sha512_224_inc_finalize
  * or OQS_SHA2_sha512_256_inc_ctx_release.
  *
  * \param state Pointer to the state
  */
 void OQS_SHA2_sha512_224_inc_init(OQS_SHA2_sha512_ctx *state);
 ...
 */
 ...
 /**
  * \brief Allocate and initialize the state for the SHA-512-256 incremental hashing API.
  *
  * \warning The state must be released by OQS_SHA2_sha512_256_inc_finalize
  * or OQS_SHA2_sha512_256_inc_ctx_release.
  *
  * \param state Pointer to the state
  */
 void OQS_SHA2_sha512_256_inc_init(OQS_SHA2_sha512_ctx *state);
